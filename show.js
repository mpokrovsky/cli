...
${'-'.repeat(5*5 + 1 + userMax + dateMax + commentMax + fileNameMax)}`);
    ...
    if (data.length > 0) {
        console.log(`${'-'.repeat(5*5 + 1 + userMax + dateMax + commentMax + fileNameMax)}`);
    }
}
